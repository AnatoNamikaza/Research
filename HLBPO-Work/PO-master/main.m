...
execution_times = zeros(1, 23); % Array to store execution times for each function
...
for fn = 1:23
    ...
    execution_times(fn) = execution_time;
...
display(['Total execution time for all functions: ', num2str(total_execution_time), ' seconds']);
