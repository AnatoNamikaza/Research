...
# Dunn test for multiple comparisons
  ...
  # Probably the most popular test for this is the Dunn test, 
  # which is performed with the dunnTest function in the FSA package.  Adjustments to the 
  # p-values could be made using the method option to control the familywise error rate 
  # or to control the false discovery rate.  See ?p.adjust for details.
