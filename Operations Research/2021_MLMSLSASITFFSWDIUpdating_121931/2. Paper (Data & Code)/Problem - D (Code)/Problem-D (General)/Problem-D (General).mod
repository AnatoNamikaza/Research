 ...
 * Creation Date: Apr 14, 2017 at 11:09:27 AM
 *********************************************/
// Converting IP/MIP to LP 
//main{
...
//writeln("OBJECTIVE: ",cplex.getBestObjValue());
//}

execute PARAMS {
    cplex.tilim = 3600; // stops and returns the current solution after 3600 seconds
...
subject to 
	...
	// Inventory Balancing constraints for final_products on final_stage
	 ...
	 if(t==14 && j in allproductsonstage5_2 && l==6) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + primary_demand[j][t]; 
	 if(t==15 && j in allproductsonstage5_2 && l==6) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + primary_demand[j][t]; 
	 if(t==16 && j in allproductsonstage5_2 && l==6) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + primary_demand[j][t];							 	 	 	 	 
	 }
	 ...
	 if(t==14 && j in allproductsonstage2 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==15 && j in allproductsonstage2 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==16 && j in allproductsonstage2 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];	
	 ...
	 if(t==14 && j in allproductsonstage3 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==15 && j in allproductsonstage3 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==16 && j in allproductsonstage3 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];	
	 ...
	 if(t==14 && j in allproductsonstage4 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==15 && j in allproductsonstage4 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==16 && j in allproductsonstage4 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];	
 }	 			
	//Capacity Constraints
	   forall (l in productionstages, t in macroperiods)
	    ...
	    if(l==2 && t==14) 
	     	...
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods14tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==15) 
	     	sum(j in allproductsonstage2, s in microperiods15tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2, s in microperiods15tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods15tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==16) 
	     	sum(j in allproductsonstage2, s in microperiods16tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2, s in microperiods16tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods16tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==3 && t==1) 
	     ...
	     if(l==6 && t==14) 
	     	...
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods14tomacroperiod) sb[l][s] <= productstagecapacity[l];	
	     if(l==6 && t==15) 
	     	sum(j in allproductsonstage5_2, s in microperiods15tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5_2, s in microperiods15tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods15tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==6 && t==16) 
	     	sum(j in allproductsonstage5_2, s in microperiods16tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5_2, s in microperiods16tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods16tomacroperiod) sb[l][s] <= productstagecapacity[l];					
	     } 
