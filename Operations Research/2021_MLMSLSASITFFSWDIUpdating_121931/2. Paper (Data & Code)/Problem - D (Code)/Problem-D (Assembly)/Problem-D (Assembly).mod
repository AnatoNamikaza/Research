 ...
 * Creation Date: Apr 13, 2017 at 2:45:29 PM
 *********************************************/
execute Timelimit{
		cplex.tilim=3600;
				 }
main{
	...
	if (cplex.solve())
	{
		...
		var ofile = new IloOplOutputFile("E:/2. Research Work (PhD-MS&E)/0. My Research Work/2. MGLSPMS with forecast updates/2. Paper (Data & Code)/Problem - D (Code)/All Results (P-D)/TAS1C1D2.txt");
		...
		var obj = cplex.getObjValue();
			...
			// Computation time with respect to CPU Elapsed time "In setting(.ops); computation repoting time = CPU time"
...
// Define & Initialize Sets
	...
	{int} microperiods15tomacroperiod = ...;
	{int} microperiods16tomacroperiod = ...;
...
subject to 
	...
	// Inventory Balancing constraints for final_products on final_stage
	 ...
	 if(t==14) 
	 	...
	 	== inventory[j][t] + primary_demand[j][t]; 
	 if(t==15) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + primary_demand[j][t]; 
	 if(t==16) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + primary_demand[j][t]; 							 	 	 	 	 
	 }
	 ...
	 if(t==14 && j in allproductsonstage1 && l==1) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==15 && j in allproductsonstage1 && l==1) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==16 && j in allproductsonstage1 && l==1) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];											
	 ...
	 if(t==3 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods3tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==4 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods4tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==5 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods5tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==6 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods6tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==7 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods7tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==8 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods8tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==9 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods9tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==10 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods10tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==11 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods11tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==12 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods12tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];	
	 if(t==13 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods13tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==14 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==15 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==16 && j in allproductsonstage2_1 && l==2) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];											
	 ...
	 if(t==3 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods3tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==4 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods4tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==5 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods5tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==6 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods6tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==7 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods7tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==8 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods8tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==9 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods9tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==10 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods10tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==11 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods11tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==12 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods12tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];	
	 if(t==13 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods13tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==14 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==15 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==16 && j in allproductsonstage2_2 && l==3) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];											
	 ...
	 if(t==3 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods3tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==4 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods4tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==5 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods5tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==6 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods6tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==7 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods7tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==8 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods8tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==9 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods9tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==10 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods10tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==11 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods11tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==12 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods12tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];	
	 if(t==13 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods13tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==14 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==15 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==16 && j in allproductsonstage3 && l==4) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];											
	 ...
	 if(t==3 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods3tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==4 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods4tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==5 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods5tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==6 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods6tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==7 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods7tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==8 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods8tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==9 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods9tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==10 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods10tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==11 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods11tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==12 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods12tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];	
	 if(t==13 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods13tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==14 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods14tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==15 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods15tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];
	 if(t==16 && j in allproductsonstage4 && l==5) 
	 	inventory[j][t-1] + sum(s in microperiods16tomacroperiod) productionquantity[j][l][s] 
	 	== inventory[j][t] + BOM * secondary_demand[j][t];											
 	 }
	//Capacity Constraints
	   forall (l in productionstages, t in macroperiods)
	    Capacity_Stage: { 
	     ...
	     if(l==1 && t==15) 
	     	sum(j in allproductsonstage1, s in microperiods15tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage1, s in microperiods15tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods15tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==1 && t==16) 
	     	sum(j in allproductsonstage1, s in microperiods16tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage1, s in microperiods16tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods16tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==2 && t==1) 
	     ...
	     if(l==2 && t==3) 
	     	...
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods3tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==2 && t==4) 
	     	sum(j in allproductsonstage2_1, s in microperiods4tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods4tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods4tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==2 && t==5) 
	     	sum(j in allproductsonstage2_1, s in microperiods5tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods5tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods5tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==2 && t==6) 
	     	sum(j in allproductsonstage2_1, s in microperiods6tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods6tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods6tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==7) 
	     	sum(j in allproductsonstage2_1, s in microperiods7tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods7tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods7tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==8) 
	     	sum(j in allproductsonstage2_1, s in microperiods8tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods8tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods8tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==9) 
	     	sum(j in allproductsonstage2_1, s in microperiods9tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods9tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods9tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==10) 
	     	sum(j in allproductsonstage2_1, s in microperiods10tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods10tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods10tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==11) 
	     	sum(j in allproductsonstage2_1, s in microperiods11tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods11tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods11tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==12) 
	     	sum(j in allproductsonstage2_1, s in microperiods12tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods12tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods12tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==13) 
	     	sum(j in allproductsonstage2_1, s in microperiods13tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods13tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods13tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==14) 
	     	sum(j in allproductsonstage2_1, s in microperiods14tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods14tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods14tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==15) 
	     	sum(j in allproductsonstage2_1, s in microperiods15tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods15tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods15tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==2 && t==16) 
	     	sum(j in allproductsonstage2_1, s in microperiods16tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_1, s in microperiods16tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods16tomacroperiod) sb[l][s] <= productstagecapacity[l];
	    if(l==3 && t==1) 
	     ...
	     if(l==3 && t==3) 
	     	...
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods3tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==4) 
	     	sum(j in allproductsonstage2_2, s in microperiods4tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods4tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods4tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==5) 
	     	sum(j in allproductsonstage2_2, s in microperiods5tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods5tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods5tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==6) 
	     	sum(j in allproductsonstage2_2, s in microperiods6tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods6tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods6tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==7) 
	     	sum(j in allproductsonstage2_2, s in microperiods7tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods7tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods7tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==8) 
	     	sum(j in allproductsonstage2_2, s in microperiods8tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods8tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods8tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==9) 
	     	sum(j in allproductsonstage2_2, s in microperiods9tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods9tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods9tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==10) 
	     	sum(j in allproductsonstage2_2, s in microperiods10tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods10tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods10tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==11) 
	     	sum(j in allproductsonstage2_2, s in microperiods11tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods11tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods11tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==12) 
	     	sum(j in allproductsonstage2_2, s in microperiods12tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods12tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods12tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==13) 
	     	sum(j in allproductsonstage2_2, s in microperiods13tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods13tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods13tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==14) 
	     	sum(j in allproductsonstage2_2, s in microperiods14tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods14tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods14tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==15) 
	     	sum(j in allproductsonstage2_2, s in microperiods15tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods15tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods15tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==3 && t==16) 
	     	sum(j in allproductsonstage2_2, s in microperiods16tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage2_2, s in microperiods16tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods16tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==4 && t==1) 
	     ...
	     if(l==4 && t==14) 
	     	...
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods14tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==4 && t==15) 
	     	sum(j in allproductsonstage3, s in microperiods15tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage3, s in microperiods15tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods15tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==4 && t==16) 
	     	sum(j in allproductsonstage3, s in microperiods16tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage3, s in microperiods16tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods16tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==5 && t==1) 
	     ...
	     if(l==5 && t==14) 
	     	...
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods14tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==5 && t==15) 
	     	sum(j in allproductsonstage4, s in microperiods15tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage4, s in microperiods15tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods15tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==5 && t==16) 
	     	sum(j in allproductsonstage4, s in microperiods16tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage4, s in microperiods16tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods16tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==6 && t==1) 
	     ...
	     if(l==6 && t==3) 
	     	...
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods3tomacroperiod) sb[l][s] <= productstagecapacity[l];	
	     if(l==6 && t==4) 
	     	sum(j in allproductsonstage5, s in microperiods4tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods4tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods4tomacroperiod) sb[l][s] <= productstagecapacity[l];																												
	     if(l==6 && t==5) 
	     	sum(j in allproductsonstage5, s in microperiods5tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods5tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods5tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==6 && t==6) 
	     	sum(j in allproductsonstage5, s in microperiods6tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods6tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods6tomacroperiod) sb[l][s] <= productstagecapacity[l];	
	     if(l==6 && t==7) 
	     	sum(j in allproductsonstage5, s in microperiods7tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods7tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods7tomacroperiod) sb[l][s] <= productstagecapacity[l];	
	     if(l==6 && t==8) 
	     	sum(j in allproductsonstage5, s in microperiods8tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods8tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods8tomacroperiod) sb[l][s] <= productstagecapacity[l];																												
	     if(l==6 && t==9) 
	     	sum(j in allproductsonstage5, s in microperiods9tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods9tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods9tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==6 && t==10) 
	     	sum(j in allproductsonstage5, s in microperiods10tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods10tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods10tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==6 && t==11) 
	     	sum(j in allproductsonstage5, s in microperiods11tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods11tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods11tomacroperiod) sb[l][s] <= productstagecapacity[l];	
	     if(l==6 && t==12) 
	     	sum(j in allproductsonstage5, s in microperiods12tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods12tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods12tomacroperiod) sb[l][s] <= productstagecapacity[l];																												
	     if(l==6 && t==13) 
	     	sum(j in allproductsonstage5, s in microperiods13tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods13tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods13tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==6 && t==14) 
	     	sum(j in allproductsonstage5, s in microperiods14tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods14tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods14tomacroperiod) sb[l][s] <= productstagecapacity[l];	
	     if(l==6 && t==15) 
	     	sum(j in allproductsonstage5, s in microperiods15tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods15tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods15tomacroperiod) sb[l][s] <= productstagecapacity[l];
	     if(l==6 && t==16) 
	     	sum(j in allproductsonstage5, s in microperiods16tomacroperiod) production_time*
	     	productionquantity[j][l][s] + sum(i,j in allproductsonstage5, s in microperiods16tomacroperiod) 
	     	setuptime[j]*Pchangeover[i][j][l][s] + sum(s in microperiods16tomacroperiod) sb[l][s] <= productstagecapacity[l];					
	     } 
